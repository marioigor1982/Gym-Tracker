...
const WorkoutList: React.FC<WorkoutListProps> = ({ workouts, onStartWorkout, onEditWorkout, onDeleteWorkout, completedTodayIds }) => {
                ...
                {imageUrl ? (
                  <>
                    <div className="relative h-40">
                      ...
                      <h3 className="absolute bottom-4 left-6 text-2xl font-bold text-white z-10">{workout.name}</h3>
                    </div>
                  ...
                  <div className="p-6 flex-grow flex flex-col justify-between">
                    <div>
                      <h3 className="text-xl font-bold text-blue-400 mb-3">{workout.name}</h3>
                      {exerciseContent}
                    </div>
                    {actionButtons}
                  </div>
