...
export const predefinedExercises: PredefinedExercise[] = [
  ...
  { name: 'Elevação da Pelve', category: 'Perna', imageUrl: 'https://www.hipertrofia.org/blog/wp-content/uploads/2024/07/barbell-lying-lifting-on-hip.gif' },
  { name: 'Abdução', category: 'Perna', imageUrl: 'https://www.hipertrofia.org/blog/wp-content/uploads/2024/09/lever-seated-hip-abduction.gif' },
